...
CREATE TABLE `invitation_links`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `link_code` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `question_options`  (
  `question_id` bigint NOT NULL,
  `option_content` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  INDEX `idx_question_id`(`question_id` ASC) USING BTREE,
...
CREATE TABLE `question_result_correct_answers`  (
  ...
  `correct_answer` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `question_result_user_answers`  (
  `question_result_id` bigint NOT NULL,
  `user_answer` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `question_results`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `explanation` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
...
CREATE TABLE `user_courses`  (
  ...
  `watch_progress` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `users`  (
  ...
  `work_unit` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `training_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `job_category` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `face_photo_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,

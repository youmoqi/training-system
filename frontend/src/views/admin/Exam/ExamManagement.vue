  ...
  <div class="page-container">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <!-- 空状态 -->
        <el-empty v-if="!loading && exams.length === 0" description="暂无试卷数据"/>
      </div>
    </div>
      ...
      <div class="dialog-body">
        <el-form :model="examForm" :rules="rules" ref="examFormRef" label-width="100px">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="总分" prop="totalScore">
                <el-input-number v-model="examForm.totalScore" :min="1" :max="200"/>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="及格分" prop="passScore">
                <el-input-number v-model="examForm.passScore" :min="1" :max="200"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="20">
            ...
            <el-col :span="12">
              <el-form-item label="是否上线" prop="isOnline">
                <el-switch v-model="examForm.isOnline"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="考试分类" prop="examCategory">
                <el-select v-model="examForm.examCategory" placeholder="请选择考试分类">
            ...
            <el-row :gutter="20">
              <el-col :span="8">
                <el-form-item label="单选题分值">
                  <el-input-number v-model="examForm.singleChoiceScore" :min="1" :max="10"/>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="多选题分值">
                  <el-input-number v-model="examForm.multipleChoiceScore" :min="1" :max="10"/>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="判断题分值">
                  <el-input-number v-model="examForm.trueFalseScore" :min="1" :max="10"/>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20" style="margin-top: 5px">
              <el-col :span="10">
                <el-form-item label="填空题分值">
                  <el-input-number v-model="examForm.fillBlankScore" :min="1" :max="10"/>
                </el-form-item>
              </el-col>
              <el-col :span="10">
                <el-form-item label="简答题分值">
                  <el-input-number v-model="examForm.shortAnswerScore" :min="1" :max="10"/>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form-item>
          <el-form-item label="可见角色" prop="visibleRoleIds">
            <el-select
                v-model="examForm.visibleRoleIds"
                multiple
  ...
  setup() {
    ...
    const loadExams = async () => {
      ...
      try {
        ...
        const response = await api.get('/exams/page', {params})
    ...
    const submitExam = async () => {
      try {
        ...
        if (isEdit.value) {
          await api.put(`/exams/${examForm.id}`, examForm)
    ...
    const viewExam = (paper) => {
      router.push(`/admin/exams/${paper.id}`)
    }

    const manageQuestions = (paper) => {
      router.push(`/admin/exams/${paper.id}/questions`)
    }

    const autoGenerate = (paper) => {
      router.push(`/admin/exams/${paper.id}/auto-generate`)
    }
